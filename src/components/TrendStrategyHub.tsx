...
export default function TrendStrategyHub({ data }: TrendStrategyHubProps) {
  ...
  return (
    <motion.div
      ...
      className={`mb-6 rounded-xl border backdrop-blur-md p-5 md:p-8 flex flex-col md:flex-row gap-5 md:gap-10 transition-all duration-500 w-full ${style.border} ${style.bg} ${style.shadow}`}
    >
